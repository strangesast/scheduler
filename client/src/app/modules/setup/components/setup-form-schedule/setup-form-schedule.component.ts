    ...
    <form [formGroup]="form">
      ...
      <mat-form-field appearance="fill">
        ...
        <mat-select formControlName="weekStartDate">
          <mat-option value="value" *ngFor="let value of weekDays">{{
            value
          }}</mat-option>
        </mat-select>
      </mat-form-field>
      <mat-button-toggle-group
        multiple="true"
        name="openDays"
        aria-label="Days Open"
        formControlName="daysOpen"
      >
        <mat-button-toggle [value]="value" *ngFor="let value of weekDays">{{
          value
        }}</mat-button-toggle>
      </mat-button-toggle-group>
    </form>
